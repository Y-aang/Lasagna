...
class MLPGateDataset(InMemoryDataset):
    ...
    def process(self):
        data_list = []
        tot_pairs = 0
        circuits = read_npz_file(self.args.circuit_file, self.args.data_dir)['circuits'].item()     # 读的是graph.npz from prepare_dataset.py
...
data_path = "/data/yangshen/template/DeepGate2/data/train/inmemory_norc/data.pt"
data, slices = torch.load(data_path)

print("Data object:", data)
print("Slices info:", slices)
