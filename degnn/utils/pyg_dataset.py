...
class pyg_dataset(Dataset):
    ...
    # Read learning targets
        ...
        with open(f"/data/yangshen/template/chips/de_hnn/data/2023-03-06_data/all.idx_to_design.pkl", "rb") as f:
            idx_dict = pickle.load(f)
            
        first_index = idx_dict[graph_index]
        
        with open(f"/data/yangshen/template/chips/de_hnn/data/2023-03-06_data/{first_index}.nn_conn.pkl", "rb") as f:
